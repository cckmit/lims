package com.adc.da.pc_budget_reimbursement.page;
...
/**
 * <b>功能：</b>PC_BUDGET_REIMBURSEMENT PcBudgetReimbursementEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2019-11-12 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class PcBudgetReimbursementEOPage extends BasePage {

    @ApiModelProperty(value = "试验委托ID")
    private String trialId;
    @ApiModelProperty(value = "试验委托编号")
    private String trialCode;
    @ApiModelProperty(value = "报销申请单编号")
    private String code;
    @ApiModelProperty(value = "报销费用总计")
