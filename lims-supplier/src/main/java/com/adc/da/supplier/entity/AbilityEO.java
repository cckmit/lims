...
public class AbilityEO extends BaseEntity {
    ...
    private List<SupProjectEO> projectEOList;
    ...
    public List<SupProjectEO> getSupProjectEOList() {
        return projectEOList;
    }

    public void setSupProjectEOList(List<SupProjectEO> projectEOList) {
        this.projectEOList = projectEOList;
    }
